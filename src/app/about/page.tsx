            ...
            <div className="max-w-4xl mx-auto space-y-16">
                ...
                >
                    ...
                    <p className="mt-4 text-xl text-slate-500 dark:text-slate-400">
                        Reimagining the lost and found experience with the power of Artificial Intelligence.
                    </p>
                </motion.div>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center md:grid-flow-col-dense">
                    <div className="h-64 rounded-2xl overflow-hidden order-2 md:order-1">
                        <img 
                            src="/about2.png" 
                            alt="FindIt Hub AI Solution" 
                            className="w-full h-full object-cover"
                        />
                    </div>
                    <div className="space-y-4 order-1 md:order-2">
                        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">The FindIt <span className="text-teal-600 dark:text-teal-400">Hub</span></h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                            FindIt Hub uses advanced <b>Vector Embeddings</b> and <b>Generative AI</b> to match lost items with found reports based on semantic similarity. It doesn't just look for keywords; it understands what your item is. Coupled with a secure verification system, we ensure that items are returned to their rightful owners safely.
                        </p>
                    </div>
                </section>
